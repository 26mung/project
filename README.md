...
### 🎨 UI/UX 대폭 개선 (토스 스타일)
- **Pretendard 폰트**: 깔끔한 한글 타이포그래피
- **카드 기반 레이아웃**: 부드러운 그림자와 호버 효과
- **토스 컬러 시스템**: toss-blue (#3182f6), toss-gray 팔레트
- **부드러운 애니메이션**: fade-in, slide-up, scale-in 효과
- **토스트 알림**: 브라우저 alert 대신 우아한 토스트 메시지
- **개선된 모달**: 더 큰 둥근 모서리와 부드러운 배경 블러
- **친근한 메시지**: 더 따뜻하고 친근한 톤앤매너
- **상대 시간 표시**: "3시간 전", "방금 전" 등 직관적인 시간 표시
- **아이콘과 배지**: 상태를 한눈에 파악할 수 있는 시각적 요소
